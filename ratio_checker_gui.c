...
LPCTSTR doubleToLPCTSTR(double value)
{
    ...
    _sntprintf(buffer, sizeof(buffer) / sizeof(buffer[0]), _T("%.*f"),
...
{
    MessageBoxW(hwnd,
        L"Copyright (c) 2023 Vitaliy Pavlov\nSource code: "
        L"https://github.com/v-2841/ratio_checker",
        L"About", MB_OK);
}
...
void menu(HWND hwnd)
{
    ...
    AppendMenu(
        hFileMenu, MF_STRING, IDM_OPEN_BUTTON, _T("Open Data File...\tCtrl+O"));
    AppendMenu(hFileMenu, MF_SEPARATOR, 0, NULL);
    AppendMenu(hFileMenu, MF_STRING, IDM_EXIT, _T("Exit\tAlt+F4"));

    HMENU hHelpMenu = CreatePopupMenu();
    AppendMenu(hHelpMenu, MF_STRING, IDM_ONLINE_HELP, _T("Online manual"));
    AppendMenu(hHelpMenu, MF_SEPARATOR, 0, NULL);
    AppendMenu(hHelpMenu, MF_STRING, IDM_ABOUT, _T("About Ratio Checker..."));
...
int main(int argc, char* argv[])
{
    ...
    hwnd = CreateWindow("window", "Ratio checker", WS_OVERLAPPEDWINDOW,
        (rctScr[0].right - 606) / 2, (rctScr[0].bottom - 419) / 2, 606, 419,
        NULL, NULL, NULL, NULL);
    ...
    HWND sample_name_name_hwnd = CreateWindow("static", "Sample name",
        WS_VISIBLE | WS_CHILD | WS_BORDER, 20, 20, 100, 20, hwnd, NULL, NULL,
        NULL);
    sample_name_hwnd
    ...
    HWND ratio1_name = CreateWindow("static", "C16:0 : C12:0",
        WS_VISIBLE | WS_CHILD | WS_BORDER, 20, 240, 310, 20, hwnd, NULL, NULL,
        NULL);
    HWND ratio2_name = CreateWindow("static", "C18:0 : C12:0",
        WS_VISIBLE | WS_CHILD | WS_BORDER, 20, 260, 310, 20, hwnd, NULL, NULL,
        NULL);
    HWND ratio3_name = CreateWindow("static", "C18:1 : C14:0",
        WS_VISIBLE | WS_CHILD | WS_BORDER, 20, 280, 310, 20, hwnd, NULL, NULL,
        NULL);
    HWND ratio4_name = CreateWindow("static", "C18:2 : C14:0",
        WS_VISIBLE | WS_CHILD | WS_BORDER, 20, 300, 310, 20, hwnd, NULL, NULL,
        NULL);
    HWND ratio5_name = CreateWindow("static",
        "C18:1 + C18:2 : C12:0 + C14:0 + C16:0 + C18:0",
        WS_VISIBLE | WS_CHILD | WS_BORDER, 20, 320, 310, 20, hwnd, NULL, NULL,
        NULL);
    HWND range_name = CreateWindow("static", "Range",
        WS_VISIBLE | WS_CHILD | WS_BORDER | SS_CENTER, 330, 220, 80, 20, hwnd,
        NULL, NULL, NULL);
    HWND range1_name = CreateWindow("static", "5.8 - 14.5",
        WS_VISIBLE | WS_CHILD | WS_BORDER | SS_CENTER, 330, 240, 80, 20, hwnd,
        NULL, NULL, NULL);
    HWND range2_name = CreateWindow("static", "1.9 - 5.9",
        WS_VISIBLE | WS_CHILD | WS_BORDER | SS_CENTER, 330, 260, 80, 20, hwnd,
        NULL, NULL, NULL);
    HWND range3_name = CreateWindow("static", "1.6 - 3.6",
        WS_VISIBLE | WS_CHILD | WS_BORDER | SS_CENTER, 330, 280, 80, 20, hwnd,
        NULL, NULL, NULL);
    HWND range4_name = CreateWindow("static", "0.1 - 0.5",
        WS_VISIBLE | WS_CHILD | WS_BORDER | SS_CENTER, 330, 300, 80, 20, hwnd,
        NULL, NULL, NULL);
    HWND range5_name = CreateWindow("static", "0.4 - 0.7",
        WS_VISIBLE | WS_CHILD | WS_BORDER | SS_CENTER, 330, 320, 80, 20, hwnd,
        NULL, NULL, NULL);
    HWND result_name = CreateWindow("static", "Result",
        WS_VISIBLE | WS_CHILD | WS_BORDER | SS_CENTER, 410, 220, 80, 20, hwnd,
        NULL, NULL, NULL);
    HWND comment_name = CreateWindow("static", "Comment",
        WS_VISIBLE | WS_CHILD | WS_BORDER | SS_CENTER, 490, 220, 80, 20, hwnd,
        NULL, NULL, NULL);

    c120_area = CreateWindow("static", doubleToLPCTSTR(c120),
        WS_VISIBLE | WS_CHILD | WS_BORDER, 100, 80, 100, 20, hwnd, NULL, NULL,
        NULL);
    c140_area = CreateWindow("static", doubleToLPCTSTR(c140),
        WS_VISIBLE | WS_CHILD | WS_BORDER, 100, 100, 100, 20, hwnd, NULL, NULL,
        NULL);
    c160_area = CreateWindow("static", doubleToLPCTSTR(c160),
        WS_VISIBLE | WS_CHILD | WS_BORDER, 100, 120, 100, 20, hwnd, NULL, NULL,
        NULL);
    c180_area = CreateWindow("static", doubleToLPCTSTR(c180),
        WS_VISIBLE | WS_CHILD | WS_BORDER, 100, 140, 100, 20, hwnd, NULL, NULL,
        NULL);
    c181_area = CreateWindow("static", doubleToLPCTSTR(c181),
        WS_VISIBLE | WS_CHILD | WS_BORDER, 100, 160, 100, 20, hwnd, NULL, NULL,
        NULL);
    c182_area = CreateWindow("static", doubleToLPCTSTR(c182),
        WS_VISIBLE | WS_CHILD | WS_BORDER, 100, 180, 100, 20, hwnd, NULL, NULL,
        NULL);
    ...
    ratio1_result = CreateWindow("static", doubleToLPCTSTR(ratio1),
        WS_VISIBLE | WS_CHILD | WS_BORDER | SS_CENTER, 410, 240, 80, 20, hwnd,
        NULL, NULL, NULL);
    ratio2_result = CreateWindow("static", doubleToLPCTSTR(ratio2),
        WS_VISIBLE | WS_CHILD | WS_BORDER | SS_CENTER, 410, 260, 80, 20, hwnd,
        NULL, NULL, NULL);
    ratio3_result = CreateWindow("static", doubleToLPCTSTR(ratio3),
        WS_VISIBLE | WS_CHILD | WS_BORDER | SS_CENTER, 410, 280, 80, 20, hwnd,
        NULL, NULL, NULL);
    ratio4_result = CreateWindow("static", doubleToLPCTSTR(ratio4),
        WS_VISIBLE | WS_CHILD | WS_BORDER | SS_CENTER, 410, 300, 80, 20, hwnd,
        NULL, NULL, NULL);
    ratio5_result = CreateWindow("static", doubleToLPCTSTR(ratio5),
        WS_VISIBLE | WS_CHILD | WS_BORDER | SS_CENTER, 410, 320, 80, 20, hwnd,
        NULL, NULL, NULL);
    ...
    ratio1_comment = CreateWindow("static", ratio1_pass,
        WS_VISIBLE | WS_CHILD | WS_BORDER | SS_CENTER, 490, 240, 80, 20, hwnd,
        NULL, NULL, NULL);
    ratio2_comment = CreateWindow("static", ratio2_pass,
        WS_VISIBLE | WS_CHILD | WS_BORDER | SS_CENTER, 490, 260, 80, 20, hwnd,
        NULL, NULL, NULL);
    ratio3_comment = CreateWindow("static", ratio3_pass,
        WS_VISIBLE | WS_CHILD | WS_BORDER | SS_CENTER, 490, 280, 80, 20, hwnd,
        NULL, NULL, NULL);
    ratio4_comment = CreateWindow("static", ratio4_pass,
        WS_VISIBLE | WS_CHILD | WS_BORDER | SS_CENTER, 490, 300, 80, 20, hwnd,
        NULL, NULL, NULL);
    ratio5_comment = CreateWindow("static", ratio5_pass,
        WS_VISIBLE | WS_CHILD | WS_BORDER | SS_CENTER, 490, 320, 80, 20, hwnd,
        NULL, NULL, NULL);
